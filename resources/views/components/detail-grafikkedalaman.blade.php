<div class="p-4 text-gray-900 flex-1 bg-white rounded-lg shadow-md">
    ...
    <div class="flex items-center mb-6">
        ...
        <p class="mr-2 font-semibold"> Detail Grafik Sensor pH</p> 
    ...
    <div class=" h-full w-full ">
        <canvas id="SensorkedalamanChart" class="w-full h-full"></canvas>
    <div >
</div>
...
<script>
    const ctx = document.getElementById('SensorkedalamanChart').getContext('2d');
