    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6  lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Notification Button & Garis Pembatas -->
                <div class="flex items-center space-x-4">
                    ...
                    <button class="relative">
                        ...
                        <!-- Badge Notification -->
                        <span class="absolute top-0 right-0 inline-block w-2 h-2 transform translate-x-1 -translate-y-1 bg-red-600 rounded-full"></span>
                    </button>

                           <!-- Garis Pembatas Vertikal -->
                     <div class="border-l-2 border-gray-400 h-8"></div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center  px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <img class="w-10 h-10 mx-auto rounded-full " src="https://i.pravatar.cc/300" alt="" width="39" height="39" />
                            <!---username-->
