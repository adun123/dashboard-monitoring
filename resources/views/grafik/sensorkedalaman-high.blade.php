    ...
    <div class="">
        ...
        <div class="h-[200px]">
            ...
            <div class="flex justify-between items-center mb-4">
                <!-- Sensor Ph -->
                <p class="text-lg font-semibold text-gray-900">High Grafik Sensor Kedalaman</p>
            </div>
            ...
            <div class="flex space-x-4  rounded-md p-4 ">
                ...
                <div class="flex-1 flex items-center justify-center">
                    <!-- Canvas untuk grafik -->
                    <canvas id="sensorkedalamanChartHigh" class="h-full w-full"></canvas>
                </div>
        ...
        <script>
            const ctx = document.getElementById('sensorkedalamanChartHigh').getContext('2d');
